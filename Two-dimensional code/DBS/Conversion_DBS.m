function [groupDelay,groupDD,Amp17]=Conversion_DBS(Matrix,h)
global Matrixnumber;
global kk;
...
Amp17=Amp(17);
filename0=strcat('E:\huangbaoze\matlab\Two-dimensional code\DBS\Matrix\Matrix',num2str(Matrixnumber),'.xlsx');
xlswrite(filename0,Matrix,'A1');
%写入表格
Matrixnumber_period_GD_GDD_rmse_Amp17 = [Matrixnumber,46.4,groupDelay,groupDD,rmse,Amp(17)];
filename1 ='Matrixnumber_period_GD_GDD_rmse_Amp17.xlsx';
xlRange = strcat('A',num2str(kk));%EXCEL 里面从A列kk行开始存储

xlswrite(filename1,Matrixnumber_period_GD_GDD_rmse_Amp17,1,xlRange);
